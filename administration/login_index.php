  ...
  <body>
    <body>
            ...
            <div class="navbar navbar-dark bg-dark box-shadow">
                <div class="container d-flex justify-content-between">
                    <a href="#" class="navbar-brand d-flex align-items-center">
                        ...
                        <img style="max-height:40px; max-width:40px;" src="img/logo.png" alt="logo">
                    </a>
        ...
        <div class="main">
            ...
            <div class="jumbotron text-left jumbotron-fluid ">
                <div class="container">
                    <!-- <img src="img/bg.png" class="animated bounceIn img-fluid mb-2 d-block mx-auto" alt=""> -->
                    <br>
                    <h1 class="display-4">Animation Learning Kids</h1>
                    <p class="lead">We teach kids with animation</p>
    <div class="box"></div>
                    <p class="lead">
                        <a class="btn btn-secondary" href="Jumbo action link" role="button">Play now</a>
                    </p>
                </div>
            </div>
            ...
            <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
                <div class=" mr-md-3 pt-3 px-3 pt-md-5 px-md-5">
                        <div class="card round-card" >
                          <img class="card-img-top image-round-card" src="img/Interactive.gif" alt="Card image" style="width:100%">
                          <div class="card-body">
                            <h3 class="card-title">Interactive</h3>
                            <p class="card-text">A way of learning for kids where they can interact with the animation by clicking so they can learn more about things</p>
                            <a href="#" class="btn btn-form btn-primary">Play</a>
                          </div>
                        </div>
                </div>
                <div class=" mr-md-3 pt-3 px-3 pt-md-5 px-md-5">
                        <div class="card round-card" >
                          <img class="card-img-top image-round-card" src="img/animation.gif" alt="Card image" style="width:100%">
                          <div class="card-body">
                            <h3 class="card-title">Animation</h3>
                            <p class="card-text">Kids will watch educational animations and learn more and more about everything</p>
                            <a href="#" class="btn btn-form btn-primary">Play</a>
                          </div>
                        </div>
                </div>
